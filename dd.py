...
token = req.text
ki = LineClient(authToken=token, appName="CHROMEOS\t2.1.5\tEater\t1")
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kg.sendMessage(msg.to, "Pasukan Dragon Hadir")
                                kh.sendMessage(msg.to, "Pasukan Dragon Hadir")
