...
cl = LineClient("EAJdarmzjYxQSv3Tfrg7.6kx2BHOPoMUj2bpRGqwrbW.Ja7ehEpZ108MMFRS5jqsCbu6Zluj1po8rKVFj6k5sEY=")
...
#token = req.text
ki = LineClient("EAiqYcXAeFwVYmxRTIbc.9WlmnxWnwkAl0JLN/ypEha.E9vaqO8Wkkc7CqgdWyb4/EpTlbTZxOHuV78x1ek9QW0=")
...
#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
#kk = LineClient(authToken=token, appName="CHROMEOS\t2.1.5\tEater\t1")
#kk.log("Auth Token : " + str(kk.authToken))
#kk.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
#kc = LineClient(authToken=token, appName="CHROMEOS\t2.1.5\tEater\t1")
#kc.log("Auth Token : " + str(kc.authToken))
#kc.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
#kb = LineClient(authToken=token, appName="CHROMEOS\t2.1.5\tEater\t1")
#kb.log("Auth Token : " + str(kb.authToken))
#kb.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
#kd = LineClient(authToken=token, appName="CHROMEOS\t2.1.5\tEater\t1")
#kd.log("Auth Token : " + str(kd.authToken))
#kd.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
#ke = LineClient(authToken=token, appName="CHROMEOS\t2.1.5\tEater\t1")
#ke.log("Auth Token : " + str(ke.authToken))
#ke.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
#kf = LineClient(authToken=token, appName="CHROMEOS\t2.1.5\tEater\t1")
#kf.log("Auth Token : " + str(kf.authToken))
#kf.log("Channel Access Token : " + str(channel.channelAccessToken))

#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
ki = LineClient("EAI50u6i2KAdjiTegdp1.S8onZtw5zv5UJn6lN/BB4q.hm7niTsY2Ai1yumwatmQ5byJnF6WMgT9/Ig1DKxyDls=")
...
#req= requests.get("https://api.eater.pw/virtual?header=CHROMEOS&id=")#ganti asddsa dengan id kalian
#token = req.text
sw = LineClient("EArPCtqZA3hIM9JknLg0.3Ue5K3qM3D42m7t4fN5kma.DlHkYu4bcy3O+23UxW8DCZYdO1rZe8YT0n9/P5kgC3Y=")
...
poll = LinePoll(cl)
call = cl
creator = ["ue8a5f66e1a293a6b89d813eb81059107"]
owner = ["ue8a5f66e1a293a6b89d813eb81059107"]
admin = ["ue8a5f66e1a293a6b89d813eb81059107"]
staff = ["ue8a5f66e1a293a6b89d813eb81059107"]
                     ...
                     return
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"ผู้สร้าง Bot Protect Thailand\nBot Line By: You ") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                        ...
                        elif cmd == "เทส" or text.lower() == 'aim':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "เจ้าของ Bot Protect Thailand \n", "")
                               msg.contentType = 13
...
#                                wait["myProfile"]["coverId"] = str(coverId)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 กำลังรีบูต 」\nเจ้าของ ", "\nBot Protect Thailand")
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                Ticket = cl.reissueGroupTicket(msg.to)
                                kj.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kj.sendMessage(msg.to, "ผีมาแล้ว "+str(G.name))
                                sw.acceptGroupInvitationByTicket(msg.to,Ticket)
                                sw.sendMessage(msg.to, "ผีมาแล้ว "+str(G.name))
                            ...
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                kj.sendMessage(msg.to, "ผีไปก่อนจ๊ะ "+str(G.name))
                                kj.leaveGroup(msg.to)
                                sw.sendMessage(msg.to, "ผีไปก่อนจ๊ะ "+str(G.name))
                                sw.leaveGroup(msg.to)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kj.sendMessage(msg.to, "[🔰 Ⓓⓚ~ⒷⓄⓣ☯t]9")
                                sw.sendMessage(msg.to, "[🔰 Ⓓⓚ~ⒷⓄⓣ☯t]10")
                                cl.sendMessage(msg.to, "╔═══╗\n║╔═╗║\n║║─║╠╗╔╦══╦═╗\n║╚═╝║╚╝║╔╗║╔╗╗\n║╔═╗║║║║╔╗║║║║\n╚╝─╚╩╩╩╩╝╚╩╝╚╝")
...
#===========BOT UPDATE============#
                        elif msg.text in ["แทค","Tagall","..",".","Assalamualaikum","Pagi","Siang","Sore","Malam","Nah","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
...
#===========Hiburan============#
                        ...
                        elif cmd == "บอท" or text.lower() == 'contact bot':
                            if msg._from in admin:
                                ma = ""
                                for i in Bots:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              mc = "「%i」ล้างบันชีดำ" % len(ragets)
                              cl.sendMessage(msg.to,"ล้างดำเรียบร้อย " +mc)
...
#===========COMMAND ON OFF============#
                        ...
                        elif cmd == "เปิดแทคเตะ" or text.lower() == 'notag on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                        ...
                        elif cmd == "เปิดเข้า" or text.lower() == 'autojoin on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = True
                                cl.sendText(msg.to,"「 🌀 」\nเปิดเรียบร้อย...")
